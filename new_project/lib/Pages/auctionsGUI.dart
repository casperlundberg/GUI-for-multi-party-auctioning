...
class AuctionsGUI extends StatelessWidget {
  ...
  AuctionsGUI(this.navigate, this.availableFilters, this.activeFilters, this.inactiveFilters, this.updateFilters, this.deleteFilter, this.activateFilter,
      this.deactivateFilter, this.ongoingAuctionList, this.finishedAuctionList, this.createAuction, this.setCurrentAuction);
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: <Widget>[
        ...
        Center(child: Auctions(navigate, ongoingAuctionList, finishedAuctionList, createAuction, setCurrentAuction, activeFilters)),
